...
parser.add_argument("--genre", help="which genre to scrape", choices=genre_list, default='mosaic')
...
def get_painting_list(count, typep, searchword):
    try:
        ...
        soup = BeautifulSoup(urllib3.request.urlopen(url), "lxml")
...
def downloader(link, genre, output_dir):
    ...
    try:
        ...
        urllib3.request.urlretrieve(file, savepath)
        num_downloaded += 1
