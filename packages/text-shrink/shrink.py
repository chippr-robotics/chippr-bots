...
def sentence_similarity(sent1, sent2, stopwords=None):
    ...
    # ie mark words in vector1 that are not not stop words
    for w in sent1:
        if w in stopwords:
            continue
...
def generate_summary(file_name, top_n=5):
    ...
    #Step 5 - grab the top n sentences
...
# main
filelist = ff.get_filelist("./articles")
for files in filelist:
    (summary) = generate_summary( "./articles/" + files, 5)
    ff.save_summary(summary, "./summary/" + files)
